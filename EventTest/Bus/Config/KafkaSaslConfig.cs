...
namespace EventTest.EventBus
{
    public class KafkaSaslConfig
    {
        ...
        /// importance: low
        /// </summary>
        public string KerberosKinitCmd { get; set; }
        ...
        /// importance: low
        /// </summary>
        int? KerberosMinTimeBeforeRelogin { get; set; }
        ...
        /// importance: low
        /// </summary>
        public string OauthbearerConfig { get; set; }
        ...
        /// importance: low
        /// </summary>
        bool? EnableOauthbearerUnsecureJwt { get; set; }
    }
}
